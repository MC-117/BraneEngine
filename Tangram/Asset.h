...
class MeshActorAssetInfo : public AgentInfo {
	MeshActorAssetInfo();
public:
	static MeshActorAssetInfo assetInfo;

	virtual void* load(const string& name, const string& path, const vector<string>& settings, const vector<void*>& dependences) const;
	virtual void* instance(const void* src, vector<string> settings, const string& displayName) const;
	static AssetInfo& getInstance();
};
...
class CollisionActorAssetInfo : public AssetInfo {
	CollisionActorAssetInfo();
public:
	static CollisionActorAssetInfo assetInfo;
