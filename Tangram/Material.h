...
public:
	...
	void processBaseData(Matrix4f& projectionViewMat, Matrix4f& transformMat, Matrix4f& lightSpaceMat, Vector3f& cameraLoc, Vector3f& cameraDir, void(*addition)(void* obj, int) = NULL, void* passObj = NULL);
	void processShader(Matrix4f& projectionViewMat, Matrix4f& transformMat, Matrix4f& lightSpaceMat, Vector3f& cameraLoc, Vector3f& cameraDir, void(*addition)(void* obj, int) = NULL, void* passObj = NULL);
	void stopShader();
